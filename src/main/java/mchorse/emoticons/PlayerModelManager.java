...
import mchorse.emoticons.animation.Animation;
import mchorse.emoticons.animation.AnimationMeshConfig;
import mchorse.emoticons.animation.json.AnimationMeshConfigAdapter;
import mchorse.emoticons.animation.json.AnimatorConfigAdapter;
import mchorse.emoticons.animation.json.AnimatorHeldItemConfigAdapter;
import mchorse.emoticons.animation.model.AnimatorConfig;
import mchorse.emoticons.animation.model.AnimatorHeldItemConfig;
import mchorse.emoticons.bobj.BOBJLoader;
import mchorse.emoticons.emoticons.Emote;
import mchorse.emoticons.emoticons.Icon;
import mchorse.emoticons.emoticons.PropEmote;
import mchorse.emoticons.emoticons.christmas.IcebergEmote;
import mchorse.emoticons.emoticons.christmas.PresentEmote;
import mchorse.emoticons.emoticons.emoticons.CryingEmote;
import mchorse.emoticons.emoticons.emoticons.DisgustedEmote;
import mchorse.emoticons.emoticons.emoticons.SneezeEmote;
import mchorse.emoticons.emoticons.emoticons.StarPowerEmote;
import mchorse.emoticons.emoticons.halloween.RisingFromDeadEmote;
import mchorse.emoticons.emoticons.halloween.TrickOrTreatEmote;
import mchorse.emoticons.emoticons.newyear.ChampagneEmote;
import mchorse.emoticons.emoticons.thanksgiving.PumpkinEmote;
import mchorse.emoticons.emoticons.valentines.BlowKissEmote;
...
public class PlayerModelManager {
   ...
   private void setEmoteIcon(String s, int i, int j) {
      ...
      if (emote != null) {
         emote.icon = new Icon(new ResourceLocation("blc/textures/slideout/emotes/icons/" + s + ".png"), i, j);
      }
   }
